...
if ENV:
    ...
    from KushinaAnimeBot.config import Development as Config
    TOKEN = Config.TOKEN
...
telethn = TelegramClient("Kushina", API_ID, API_HASH)
pgram = Client("EmiPyro", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
mongo_client = MongoClient(MONGO_DB_URI)
db = mongo_client.KushinaAnimeBot
...
from KushinaAnimeBot.modules.helper_funcs.handlers import (CustomCommandHandler,
...
INFO GATHERED!
Client: Kushina Pyro
Copyright: (c) 2021 KushinaAnimeBot
"""
print(end_credits)
