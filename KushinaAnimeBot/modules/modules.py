...
from KushinaAnimeBot.__main__ import (CHAT_SETTINGS, DATA_EXPORT, DATA_IMPORT,
...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("KushinaAnimeBot.modules." +
                                                  text)
    except:
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("KushinaAnimeBot.modules.", 1)[1]
