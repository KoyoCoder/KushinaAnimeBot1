...
from KushinaAnimeBot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from KushinaAnimeBot.__main__ import STATS, TOKEN, USER_INFO
import KushinaAnimeBot.modules.sql.userinfo_sql as sql
from KushinaAnimeBot.modules.disable import DisableAbleCommandHandler
from KushinaAnimeBot.modules.sql.global_bans_sql import is_user_gbanned
from KushinaAnimeBot.modules.sql.afk_sql import is_afk, check_afk_status
from KushinaAnimeBot.modules.sql.users_sql import get_user_num_chats
from KushinaAnimeBot.modules.helper_funcs.chat_status import sudo_plus
from KushinaAnimeBot.modules.helper_funcs.extraction import extract_user
from KushinaAnimeBot import telethn as KushinaTelethonClient
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        text += "\n\nThe Ranking of The Person is Owner of Kushina"
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nThis Person is a Developer of Kushina"
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThis Person is a Sudo-User of Kushina"
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nThis Person is a Support User of Kushina"
        disaster_level_present = True
    elif user.id in TIGERS:
        text += "\n\nThis User is Immune to all Restrictions over Kushina"
        disaster_level_present = True
