...
import KushinaAnimeBot.modules.sql.notes_sql as sql
from KushinaAnimeBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from KushinaAnimeBot.__main__ import DATA_IMPORT
from KushinaAnimeBot.modules.helper_funcs.chat_status import user_admin
from KushinaAnimeBot.modules.helper_funcs.alternate import typing_action

# from KushinaAnimeBot.modules.rules import get_rules
import KushinaAnimeBot.modules.sql.rules_sql as rulessql

# from KushinaAnimeBot.modules.sql import warns_sql as warnssql
import KushinaAnimeBot.modules.sql.blacklist_sql as blacklistsql
from KushinaAnimeBot.modules.sql import disable_sql as disabledsql

# from KushinaAnimeBot.modules.sql import cust_filters_sql as filtersql
# import KushinaAnimeBot.modules.sql.welcome_sql as welcsql
import KushinaAnimeBot.modules.sql.locks_sql as locksql
from KushinaAnimeBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Kushina{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Kushina{}.backup".format(chat_id), "rb"),
    ...
    os.remove("Kushina{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 • `/import`: Reply to the backup file for the butler / Kushina group to import as much as possible, making transfers very easy! \
