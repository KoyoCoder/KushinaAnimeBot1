...
from KushinaAnimeBot.extrastuff import SUDOERS
from KushinaAnimeBot import LOG_GROUP_ID
from KushinaAnimeBot import pgram as app 
from KushinaAnimeBot.arqclient import arq
from KushinaAnimeBot.utils.keyboard import ikb
from KushinaAnimeBot.core.tasks import _get_tasks_text, all_tasks, rm_task
from KushinaAnimeBot.core.types import InlineQueryResultCachedDocument
from KushinaAnimeBot.modules.info import get_chat_info, get_user_info
from KushinaAnimeBot.modules.media import download_youtube_audio
from KushinaAnimeBot.utils.functions import test_speedtest
from KushinaAnimeBot.utils.pastebin import paste
...
async def inline_help_func(__help__):
    ...
    answerss = [
        ...
        InlineQueryResultArticle(
            ...
            input_message_content=InputTextMessageContent(
                "https://github.com/IzumiCypherX/KushinaAnimeBot"
            ),
...
async def alive_function(answers):
    ...
    msg = f"""
**[Kushina✨](https://github.com/IzumiCypherX/KushinaAnimeBot):**
**RoBot:** `{bot_state}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Kushina's Stats",
