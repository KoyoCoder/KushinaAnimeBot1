...
from KushinaAnimeBot import MONGO_DB_URI
from KushinaAnimeBot import telethn

client = MongoClient()
client = MongoClient(MONGO_DB_URI)
db = client["kushinaanimebot"]
gbanned = db.gban
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import KushinaAnimeBot.tevents

        path = Path(f"KushinaAnimeBot/modules/{shortname}.py")
        name = "KushinaAnimeBot.modules.{}".format(shortname)
...
path = "KushinaAnimeBot/modules/*.py"
